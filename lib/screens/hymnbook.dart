...
/// A white card with the church logo watermarked faintly in its centre.
/// The watermark is clipped to the card's rounded corners, so it is
/// only ever visible inside the card itself.
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            // Logo watermark, centred inside the card only
            Positioned.fill(
              child: Center(
                child: Opacity(
                  opacity: 0.2,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Hymn Lyrics with the logo watermarked behind them
                WatermarkCard(
                  child: Text(
                    hymn['lyrics']!,
                    style: const TextStyle(
